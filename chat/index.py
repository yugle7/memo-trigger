        ...
        if db.create_user(user_id):
            answer = "\n\n".join(
                [
                    ...
                    "Я умею создавать опросы и напоминать о них",
                    "Добавьте меня в ваш чат и отправьте мне там команду /attach",
                    "В том чате вы должны быть администратором",
                ]
            )
        else:
            answer = (
                "Отправьте команду /attach в тот чат, где должны создаваться опросы"
            )
